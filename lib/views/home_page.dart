        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            onTap: (int i) {
              // ホームボタンの色を切り替える
              if (i == 0) {
                context.read<CoreModel>().toggleHomeButton(true);
              } else {
                context.read<CoreModel>().toggleHomeButton(false);
              }
            },
          ),
          ...
          child: SizedBox(
            ...
            child: TextButton(
              style: TextButton.styleFrom(
                backgroundColor: fromCssColor(
                    context.read<CoreModel>().homeButtonColors[
                        context.select((CoreModel c) => c.isHomeButton)]),
              ...
              child: Text(
                ...
                style: GoogleFonts.notoSans(
                    textStyle: TextStyle(
                        fontSize: 25,
                        fontWeight: FontWeight.bold,
                        color: fromCssColor(context
                                .read<CoreModel>()
                                .homeButtonTextColors[
                            context.select((CoreModel c) => c.isHomeButton)]))),
              ),
              onPressed: () async {
                // ホームボタンが利用不可の時、
                if (context.read<CoreModel>().isHomeButton == 1) {
                  return;
                }
